    ...
    Statement = [
      ...
      },
      {
        ...
        Resource = [
          ...
          "arn:aws:logs:${var.aws_region}:${var.aws_account_id}:log-group:/aws/lambda/${aws_lambda_function.step_02_face_detection.function_name}:*",
...
resource "aws_lambda_function" "step_02_face_detection" {
  ...
  environment {
    variables = {
      ...
      ActivityArn      = aws_sfn_activity.step_02_face_detection.id
    }
  }
