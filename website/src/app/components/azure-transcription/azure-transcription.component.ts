...
@Component({
  selector: "app-azure-transcription",
  templateUrl: "./azure-transcription.component.html",
  styleUrls: ["./azure-transcription.component.scss"]
})
export class AzureTranscriptionComponent implements OnInit, OnChanges, OnDestroy {
